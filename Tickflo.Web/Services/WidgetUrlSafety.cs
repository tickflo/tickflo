...
public static class WidgetUrlSafety
{
    ...
    /// <summary>
    /// Throws <see cref="BadRequestException"/> when <paramref name="url"/> is not a
    /// public http/https URL.
    /// </summary>
    public static async Task EnsureSafeUrlAsync(string url, CancellationToken cancellationToken)
    {
