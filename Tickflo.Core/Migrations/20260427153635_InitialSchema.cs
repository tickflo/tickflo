    ...
    public partial class InitialSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_contact_locations", x => new { x.contact_id, x.location_id });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_tokens", x => new { x.user_id, x.token });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_user_notification_preferences", x => new { x.user_id, x.notification_type });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_ticket_inventories", x => x.id);
                    table.ForeignKey(
                        name: "fk_ticket_inventories_inventory_inventory_id",
                        column: x => x.inventory_id,
                        principalTable: "inventory",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_ticket_inventories_tickets_ticket_id",
            ...
            migrationBuilder.CreateIndex(
                ...
                columns: new[] { "workspace_id", "contact_id" });
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "report_runs",
                columns: new[] { "workspace_id", "report_id", "started_at" },
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "ticket_comments",
                columns: new[] { "workspace_id", "ticket_id", "created_at" });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_ticket_inventories_inventory_id",
                table: "ticket_inventories",
                column: "inventory_id");

            migrationBuilder.CreateIndex(
                name: "ix_ticket_inventories_ticket_id",
                table: "ticket_inventories",
                column: "ticket_id");
